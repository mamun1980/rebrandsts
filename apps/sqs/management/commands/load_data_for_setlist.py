...
import json
from apps.sqs.models import SetList
...
class Command(BaseCommand):
    ...
    file_path = Path(__file__).parent.parent.parent.parent.parent / f'data/prod/set_list.json'
        ...
        try:
            with open(self.file_path, 'r') as fp:
                ...
                for data_json in data_json_list:
                    ...
                    set_list = SetList.objects.create(**data_json)
                    print(f"set_list data {set_list.name} is created")
